...
<div class="main-container container-fluid">
    ...
    <div class="page-header">
        ...
        <div>
            <div class="breadcrumb">
                <a href="blog-post.html" class="btn btn-primary"><i class="fa fa-plus-square me-2"></i>{{ __('Add Post') }}</a>
            </div>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
    ...
    <div class="row">
        <div class="col-sm-6 col-md-12 col-lg-6 col-xl-4">
            <div class="card">
                <a href="blog-details.html"><img class="card-img-top" src="../assets/images/media/13.jpg" alt="And this isn&#39;t my nose. This is a false one."></a>
            ...
            <div class="card">
                <a href="blog-details.html"><img class="card-img-top" src="../assets/images/media/15.jpg" alt="How do you know she is a witch?"></a>
                <div class="card-body d-flex flex-column">
                    <h3><a href="blog-details.html"> Voluptatem quia voluptas </a></h3>
        ...
        <div class="col-sm-6 col-md-12 col-lg-6 col-xl-4">
            <div class="card">
                <a href="blog-details.html"><img class="card-img-top" src="../assets/images/media/14.jpg" alt="Well, I didn&#39;t vote for you."></a>
                <div class="card-body d-flex flex-column">
                    <h3><a href="blog-details.html"> Voluptatem quia voluptas </a></h3>
            ...
            <div class="card">
                <a href="blog-details.html"><img class="card-img-top" src="../assets/images/media/16.jpg" alt="Shut up!"></a>
                <div class="card-body d-flex flex-column">
                    <h3><a href="blog-details.html"> Voluptatem quia voluptas </a></h3>
                ...
                <div class="card-body">
                    <div class="">
                        <div class="d-flex overflow-visible">
                            <a href="blog-details.html" class="card-aside-column br-5 cover-image" data-bs-image-src="../assets/images/media/22.jpg" style="background: url(&quot;../assets/images/media/18.jpg&quot;) center top;"></a>
                        ...
                        <div class="d-flex overflow-visible mt-5">
                            <a href="blog-details.html" class="card-aside-column br-5 cover-image" data-bs-image-src="../assets/images/media/28.jpg" style="background: url(&quot;../assets/images/media/19.jpg&quot;) center top;"></a>
                            <div class="ps-3 flex-column">
